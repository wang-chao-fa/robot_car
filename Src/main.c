        ...
        if (now - print_tick >= 200)
        {
            ...
            if (huart1.gState == HAL_UART_STATE_READY)
            {
                ...
                int len = snprintf(tx_buf, sizeof(tx_buf),
                    ...
                    "[INC] Whl(0x18B):On=%d R=%ld.%02ld | Bod(0x18C):On=%d R=%ld.%02ld | Diff=%ld.%02ld Comp=%ld.%01ld\r\n\r\n",
                    ...
                    whl_ok, whl_roll_x100 / 100, labs(whl_roll_x100 % 100),
                    bod_ok, bod_roll_x100 / 100, labs(bod_roll_x100 % 100),
